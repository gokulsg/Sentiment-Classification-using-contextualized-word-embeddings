...
def tfidf():
    ...
    # TF-IDF #
    vectorizer_tfidf.fit(train_review_body)
    X_train = vectorizer_tfidf.transform(train_review_body)
    X_val = vectorizer_tfidf.transform(valid_review_body)
    x_test = vectorizer_tfidf.transform(test_review_body)
    tfidf_vocabulary = vectorizer_tfidf.vocabulary_
